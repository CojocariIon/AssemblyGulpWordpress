...
function intensiv_scripts() {
    ...
    //css
    wp_enqueue_style('intensiv-style', get_template_directory_uri() . "/assets/css/style.css?v=" . $time);

    //js
    wp_enqueue_script('intensiv-js', get_template_directory_uri() . "/assets/js/script.js?v=" . $time);
